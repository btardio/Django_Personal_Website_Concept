...
"""
Django settings for cv_contact_form project.
...
SECRET_KEY = '^$0xc6v4zbrmqlg$28+$q9&))avv!71d8b^+&4hcr15b$pkl75'
...
TEMPLATES = [
    {
        ...
        'DIRS': ['/home/btardio/projects/cv/cv/templates/',],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
